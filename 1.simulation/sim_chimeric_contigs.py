    ...
    with open(fasta) as f:
        for line in f:
            if line.startswith('>'):
                ...
                contig_dict[temp_id] = list()
            else:
                contig_dict[temp_id].append(line.strip())

    for temp_id, seq_list in contig_dict.items():
        contig_dict[temp_id] = ''.join(seq_list)
...
def output_fasta(out_file, contig_dict, sampled_inner_chrom, sampled_inter_homo, sampled_inter_nonhomo, order_list):
    ...
    def write_lines(sampled_list, chimeric_type, n):
        ...
        for ctg_1, ctg_2 in sampled_list:
            ...
            fout.write('>{}_{}_{}_{}\n{}{}\n'.format(
                ctg_1, ctg_2, chimeric_type, ''.join([str(num) for num in order_list[5 * n:5 * n + 5]]), ctg_1_chimeric,
                ctg_2_chimeric))
    ...
    with open(out_file, 'w') as fout:
        ...
        write_lines(sampled_inter_nonhomo, 'chimeric_inter_nonhomo', n)
